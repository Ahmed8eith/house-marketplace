...
function CreateListing() {
  ...
  const storeImage = async (image) => {
    ...
    const { data, error } = supabase.storage.from('house-mages').upload(filePath, image);
    ...
    const publicUrl = supabase.storage.from('house-mages').getPublicUrl(filePath).data.publicUrl;
    return publicUrl;
  };
